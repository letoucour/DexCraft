...
- Collection, « Mettre à l’échange » (0.6.3) : sélection multiple (`tradeSel`, un exemplaire par carte, bouton « Tous mes doubles »), demande « carte manquante » ou « n’importe laquelle » de même rareté, confirmation, puis une annonce par carte (`tradeMany`, appels `dc_trade_create` successifs, aucun changement serveur).
