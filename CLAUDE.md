...
- Image de profil : plus de liste de toute la collection ; recherche (30 résultats au plus) et les 5 dernières images choisies (`avaRecent`, gardées sur l’appareil).
