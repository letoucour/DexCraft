...
- **`index.html`** : tout le jeu, environ 5 000 lignes. HTML, CSS et JavaScript dans un seul fichier, sans dépendance à part `supabase-js` chargé depuis un CDN.
...
5. Augmenter la limite de joueurs au-delà de 10, dans la fonction `check_player_limit` du SQL.
