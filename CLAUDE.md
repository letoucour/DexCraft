...
3. **Version 0.4.0 : anti-triche, en test.** Serveur arbitre en place (voir Architecture). Passage en production : lancer sur le vrai Supabase `dexcraft-supabase.sql`, `dexcraft-config.sql`, `dexcraft-serveur.sql` puis `migration-0.4.0.sql`, et pousser aussitôt.
